      ...
      <div class="d-flex">
        ...
        <div class="navbar-brand-box">
          ...
          <nuxt-link to="/" class="logo logo-dark">
            ...
            <span class="logo-sm">
              <img src="~/static/images/small_logo.png" alt="HotJobs" height="45">
            </span>

            <span class="logo-lg">
              <img src="~/static/images/logo.png" alt="HotJobs" height="28">
            </span>
              ...
              <form @submit.prevent="createEmployer()">
                <div class="modal-body">
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="form-group">
                        <label>Contact Person's Designation <span class="text-danger">*</span></label>
