...
&lt;!&ndash;            <button type="button" @click="tutorRequestSeeMore" class="btn btn-outline-info active">See more.....</button>&ndash;&gt;
        ...
        <div class="row">
          ...
          <div  class="col-lg-3 col-md-3 col-sm-12">
            <div class="companies-item category-item-box helping_hand_scrollbar scroll_style">
              <h3>
                <a href="javaScript:void(0)">onr</a>
              </h3>
            </div>
          </div>
          <div  class="col-lg-3 col-md-3 col-sm-12">
