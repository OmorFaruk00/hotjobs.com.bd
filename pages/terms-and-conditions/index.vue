          ...
          <div class="card">
            <div class="card-body contact">
              ...
              <p>
                ...
                responsibility of the visitor to further research the information on the site. Any breach of privacy or
                of the
                information provided by the consumer to
                <nuxt-link to="/">Hotjobs.com.bd</nuxt-link>
              ...
              <ol>
                ...
                <li>The Subscriber/Recruiter may use up to a maximum of 2 email id's for vacancies posted on
                  <nuxt-link to="/">Hotjobs.com.bd</nuxt-link>
              ...
              <ol>
                ...
                <li>Only one office of one corporate entity / firm will be entitled to use this service and in case
                  other offices of
                  the same company/ associated companies, want to use the said service, then, they shall be liable to
                  make
                  extra payment for the service.
                </li>
                <li>The contact information given by the subscriber for all listing should be the same and the
                  subscriber cannot
              ...
              <ol>
                ...
                <li>It is made clear that the subscriber being one corporate/business entity, cannot
                  transfer/sell/sublet the micro
                  site or any part thereof to any third party
                </li>
              </ol>
              ...
              <ol>
                ...
                <li>It is made clear that the subscriber being one corporate/business entity, cannot
                  transfer/sell/sublet the micro site or any part thereof to any third party.
                </li>
              </ol>

              <h5>SMS Services</h5>
              <ol>
                <li>"SMS Service" is to contact the potential candidates directly to make recruitment process simple,
                  effortless
                  and instantaneous not for other purposes.
                </li>

                <li>Employer/Recruiter can send the applicants only the information regarding written test, interview
                  etc. or any
                  other necessary information via hotjobs system.
                </li>

                <li>This service cannot be used for any kind of marketing purpose by the employers.
                </li>

                <li>This service cannot be used against hotjobs Terms and Conditions.
                </li>

                <li>If your company is not verified, you can not avail "SMS Service".
                </li>
