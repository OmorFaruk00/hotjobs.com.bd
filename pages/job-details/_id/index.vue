              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                  <div class="col-12">
                    ...
                    <div class="preview-box">
                      ...
                      <ul v-if="candidate_requirement.experience_type == '' || candidate_requirement.experience_type == '0'">
                        <li>Negotiable</li>
                      </ul>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body bg-light">
                      ...
                      <h5><strong>Age:</strong>
                        ...
                        <span
                          v-if="candidate_requirement.age_min != '' && candidate_requirement.age_max != ''">{{ candidate_requirement.age_min }} - {{ candidate_requirement.age_max }} years</span>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 text-center">Application Deadline:
                  <strong v-if="job_details.application_deadline !=''"
                          v-html="dateFormat(job_details.application_deadline)">{{
                      current_date }}</strong>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
                  ...
                  <span v-if="company_info_visibility.company_address_show_status !=''">{{ employer.company_address }}</span>
                  <br>

                  <span v-if="employer.website_url !=''">Web: <a target="_blank"
                                                                 :href="employer.website_url">{{ employer.website_url }}</a></span>
                  <br>
                  <span v-if="company_info_visibility.company_business_show_status !=''">Business: {{ employer.business_description }}</span>
